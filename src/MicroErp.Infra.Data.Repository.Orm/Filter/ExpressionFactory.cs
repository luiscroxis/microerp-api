...
using MicroErp.Infra.Data.Repository.Orm.Attributes;

namespace MicroErp.Infra.Data.Repository.Orm.Filter;

internal static class ExpressionFactory
{
    internal static ExpressionParserCollection GetOperators<TEntity>(object model)
    {
    ...
    internal static WhereClause GetCriteria(object model, PropertyInfo propertyInfo)
    {
